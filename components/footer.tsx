  ...
  return (
    ...
    <footer className="relative bg-black text-white min-h-[400px] flex flex-col justify-end overflow-hidden">
      <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden">
        <RetroGrid angle={65} cellSize={60} opacity={0.25} darkLineColor="#1e293b" lightLineColor="#60a5fa" />
        <section className="z-10 py-24 flex flex-col items-center justify-center text-center w-full">
        ...
        <section className="z-10 py-8 border-t border-slate-800 text-center w-full">
